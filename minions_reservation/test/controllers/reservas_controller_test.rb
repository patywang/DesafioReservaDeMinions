...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { data: @reserva.data, descricao: @reserva.descricao, minions: @reserva.minions } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { data: @reserva.data, descricao: @reserva.descricao, minions: @reserva.minions } }
